      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="flex items-center">
            <svg className="h-6 w-6 text-reddit-orange" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span className="ml-2 text-sm text-gray-500">Reddit Comment Search</span>
          </div>
          <div className="mt-4 md:mt-0">
            <p className="text-xs text-gray-500">This app is not affiliated with Reddit, Inc. Data is cached for 5 minutes.</p>
          </div>
        </div>
      </div>
    </footer>
